	...
	*/		
	...
	if( !function_exists('cryptro_register_required_plugins') ){
		function cryptro_register_required_plugins(){
			...
			$plugins = array(
				array(
					'name'               => esc_html__('Goodlayers Core', 'cryptro'),
				...
				array(
					'name'               => esc_html__('Goodlayers Core Portfolio', 'cryptro'),
				...
				array(
					'name'               => esc_html__('Goodlayers Core Personnel', 'cryptro'),
				...
				array(
					'name'               => esc_html__('Goodlayers Core Twitter', 'cryptro'),
				...
				array(
					'name'               => esc_html__('Revolution Slider', 'cryptro'),
					'slug'               => 'revslider', 
				...
				array(
					'name'      => esc_html__('Snazzy Maps', 'cryptro'),
					'slug'      => 'snazzy-maps',
					'required'  => false,
				),
			);
