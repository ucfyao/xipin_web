		...
		class gdlr_core_sidebar_generator{
			...
			function __construct( $sidebar_args = array() ){
				...
				$this->footer_widgets = array(
					array( 'name'=>esc_html__('Footer 1', 'cryptro'), 'id'=>'footer-1', 'description'=>esc_html__('Footer Column 1', 'cryptro') ), 
					array( 'name'=>esc_html__('Footer 2', 'cryptro'), 'id'=>'footer-2', 'description'=>esc_html__('Footer Column 2', 'cryptro') ), 
					array( 'name'=>esc_html__('Footer 3', 'cryptro'), 'id'=>'footer-3', 'description'=>esc_html__('Footer Column 3', 'cryptro') ), 
					array( 'name'=>esc_html__('Footer 4', 'cryptro'), 'id'=>'footer-4', 'description'=>esc_html__('Footer Column 4', 'cryptro') )
				);
			...
			function register_sidebar_widget(){
				...
				$sidebar_args['name'] = __('Preset', 'cryptro');
				$sidebar_args['id'] = 'gdlr-core-sidebar-preset';
				$sidebar_args['description'] = esc_html__('Another Custom widget area', 'cryptro');
				...
				foreach ( $this->sidebars as $sidebar ){
					...
					$sidebar_args['description'] = esc_html__('Custom widget area', 'cryptro');
