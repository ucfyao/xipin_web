<?php
	...
	echo '<div class="cryptro-above-navigation-slider" >';
	if( $post_option['header-slider'] == 'layer-slider' ){
		...
		if( class_exists('RevSliderSlider') ){
			...
			if( !empty($rev_slider[$post_option['revolution-slider-id']]) ){
				...
				echo '<p style="text-align: center;" >' . esc_html__('Please import and select the slides you want to show at the header area from the "page options" area again.', 'cryptro') . '</p>';
			}
		}
	}
	echo '</div>';