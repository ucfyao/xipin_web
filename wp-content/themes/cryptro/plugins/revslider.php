<?php
	...
	add_filter('revslider_getUsedFonts', 'cryptro_revslider_getUsedFonts');
	if( !function_exists('cryptro_revslider_getUsedFonts') ){
		function cryptro_revslider_getUsedFonts( $used_font ){
