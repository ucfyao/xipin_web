...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="cryptro-single-article" >
		<?php
				...
				if( empty($post_format) ){
					if( $feature_image_pos == 'content' ){
						...
						if( !empty($feature_image) ){
							$thumbnail_size = cryptro_get_option('general', 'blog-thumbnail-size', 'full');

							echo '<div class="cryptro-single-article-thumbnail cryptro-media-image" >';
			...
			if( $blog_style == 'magazine' && cryptro_get_option('general', 'blog-social-share', 'enable') == 'enable' ){
