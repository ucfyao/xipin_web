 ...
 */
	...
	$sidebar_type = cryptro_get_option('general', 'woocommerce-archive-sidebar', 'none');
	$sidebar_left = cryptro_get_option('general', 'woocommerce-archive-sidebar-left');
	$sidebar_right = cryptro_get_option('general', 'woocommerce-archive-sidebar-right');		
