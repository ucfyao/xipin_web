				...
				if($query->have_posts()){
					...
					while($query->have_posts()){ $query->the_post();
						...
						if( !empty($feature_image) ){
							if( in_array($style, array('style-1','style-3')) ){
								echo '<div class="gdlr-core-recent-post-widget-thumbnail gdlr-core-media-image" >' . gdlr_core_get_image($feature_image, $thumbnail_size) . '</div>';
						...
						if( $style == 'style-1' ){	
							...
							echo '<div class="gdlr-core-recent-post-widget-info">' . $blog_style->blog_info(array( 'display' => array('date', 'author'))) . '</div>';
						}else if( $style == 'style-2' ){
							echo '<div class="gdlr-core-recent-post-widget-title"><a href="' . get_permalink() . '" >' . get_the_title() . '</a></div>';
							echo '<div class="gdlr-core-recent-post-widget-info">' . $blog_style->blog_info(array( 'display' => array('date'))) . '</div>';
							...
							echo '<div class="gdlr-core-recent-post-widget-title gdlr-core-title-font"><a href="' . get_permalink() . '" >' . get_the_title() . '</a></div>';
							echo '<div class="gdlr-core-recent-post-widget-info">' . $blog_style->blog_info(array( 'display' => array('date', 'comment-number') )) . '</div>';
						}
